...
export const ClientMcaLitigationTable = () => {
    ...
    const handleView = (slug: string) => {
        push(`/litigation/${slug}?mode=view`);
    };

    const handleEdit = (slug: string) => {
        push(`/litigation/${slug}?mode=edit`);
    };
    const handleSave = () => {
        // Save logic here
        ...
        <div className="px-4 py-4 sm:px-8 sm:py-8">
            <div className="flex flex-col gap-y-6">
                ...
                <div className="flex w-full flex-wrap items-center px-3 gap-y-2  sm:flex-row  justify-between sm:px-6">
                    ...
                    <h2 className="mb-0 font-inter text-lg font-bold text-charcoal">Litigation</h2>
                    <Button value="Add Litigation" icon={<Add />} onClick={() => push('/litigation/0?mode=create')} className=" !h-[45px] !w-fit !px-6 !py-2" />
                </div>
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            columns={[
                                ...
                                { accessor: 'clientName', title: 'Client' },
                                { accessor: 'mcaCompanyName', title: 'MCA' },
                                { accessor: 'balanceRTR', title: 'Balance' },
                                { accessor: 'jurisdiction', title: 'Jurisdiction' },
                                {
                                    accessor: 'actions',
                                    title: 'Actions',
                                    render: (record) => (
                                        <div className="flex gap-x-3">
                                            ...
                                            <span
                                                ...
                                                onClick={() => handleDeleteClick(record.thirdPartyCompanyName)}
                                            >
                                                <Delete />
                                            </span>
                                        </div>
